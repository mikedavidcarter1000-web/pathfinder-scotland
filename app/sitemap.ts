...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${SITE_URL}/tools/living-costs`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/tools/ucas-calculator`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/tools/worksheet`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${SITE_URL}/tools/personal-statement`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: `${SITE_URL}/support/difficult-circumstances`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    ...
    {
      url: `${SITE_URL}/privacy/young-persons`,
      lastModified: now,
      changeFrequency: 'yearly',
      priority: 0.3,
    },
