...
const tools = [
  {
    ...
    description:
      'Generate a personalised printable worksheet for your subject choice guidance meeting — with career sector mapping, course impact analysis, and a funding snapshot.',
