...
const tools = [
  {
    ...
    description:
      'Plan subject choices for S3, S4, S5, or S6 and see what each combination opens up. Print to take to your guidance teacher meeting. No account needed.',
  ...
  {
    title: 'Personalised subject worksheet',
    description:
      'For signed-in students. Generates a worksheet using your saved choices, predicted grades, saved courses, and SAAS / bursary eligibility.',
  ...
  {
    title: 'Living cost comparison',
    description:
      'Compare accommodation and living costs at every Scottish university against your SAAS funding. Toggle between living at home and moving away for each university.',
  ...
  },
  {
    ...
    description:
      'Annotated UCAS personal statement examples from six Scottish students, plus a guided writing tool with personalised prompts.',
