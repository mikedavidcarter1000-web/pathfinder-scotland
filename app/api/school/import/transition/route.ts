...
import { runTransitionImport } from '@/lib/school/import'
...
export async function POST(req: NextRequest) {
  ...
  const transitionYear = String(form.get('transition_year') ?? currentAcademicYear())
  ...
  const result = await runTransitionImport(admin, {
