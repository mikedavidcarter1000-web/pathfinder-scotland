  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-2">
        ...
        {college.has_swap && <span className="pf-badge-amber" title="SWAP (Scottish Wider Access Programme) — free access courses for adults without traditional qualifications, leading to guaranteed university interviews">SWAP</span>}
      </div>
      <h3
        style={{
          fontSize: '1rem',
